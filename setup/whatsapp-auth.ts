...
<html><head><title>LeoBot - WhatsApp Auth</title>
...
<html><head><title>LeoBot - Connected!</title>
<style>
...
<script>localStorage.removeItem('leobot_qr_start');</script>
</body></html>`;
